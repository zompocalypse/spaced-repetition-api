    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'vandaag', translation: 'today' },
            { original: 'morgen', translation: 'tomorrow' },
            { original: 'gisteren', translation: 'yesterday' },
            { original: 'lachen', translation: 'laugh' },
            { original: 'huilen', translation: 'cry' },
            { original: 'klein', translation: 'small' },
            { original: 'groot', translation: 'large' },
            { original: 'mooi', translation: 'beautiful' },
            { original: 'lelijk', translation: 'ugly' },
            { original: 'moeilijk', translation: 'difficult' },
            { original: 'makkelijk', translation: 'easy' },
            { original: 'leraar', translation: 'teacher' },
            { original: 'leerling', translation: 'student' },
          ],
        };
        return supertest(app)
          .post('/api/user')
